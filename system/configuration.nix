...

{
  ...
  # My SSH private key is required to login.
  # Root access (via sudo) requires a password that is stored offline.
  ...
  systemd.tmpfiles.rules = [
    # Set read-only root permissions on password.nix.
    "z /etc/password.nix 400 root root - -"
  ];
